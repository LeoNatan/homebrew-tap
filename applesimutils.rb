class Applesimutils < Formula
  ...
  url 'https://github.com/LeoNatan/AppleSimulatorUtils/releases/download/0.9.2/AppleSimulatorUtils-0.9.2.tar.gz'
  ...
  bottle do
    root_url 'https://github.com/LeoNatan/AppleSimulatorUtils/releases/download/0.9.2'
